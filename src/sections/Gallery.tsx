...
export function Gallery() {
  ...
  return (
    <section
      id="gallery"
      ref={sectionRef}
      className="relative py-20 lg:py-28 bg-brand-concrete overflow-hidden"
    >
      {/* Background Pattern */}
      ...
      <div className="relative z-10">
        ...
        >
          {/* Gradient Masks */}
          <div className="absolute left-0 top-0 bottom-0 w-24 sm:w-40 bg-gradient-to-r from-brand-concrete to-transparent z-10 pointer-events-none" />
          <div className="absolute right-0 top-0 bottom-0 w-24 sm:w-40 bg-gradient-to-l from-brand-concrete to-transparent z-10 pointer-events-none" />
