          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 mb-20">
            ...
            >
              <p className="text-lg text-brand-dark leading-relaxed mb-6">
                <strong className="bg-brand-orange text-white px-1">Conveyor Track Pty Ltd</strong> is a leading supplier of conveyor belts and provider of conveyor plant repair and maintenance services. We cater to the needs of various industries, including mining, manufacturing, and logistics.
              </p>
              <p className="text-lg text-brand-dark leading-relaxed mb-8">
                Founded by <strong className="bg-brand-orange text-white px-1">Mr. Mona Prince</strong> (pictured right), a visionary entrepreneur with a passion for delivering exceptional quality and service, our company is committed to excellence and dedicated to making a positive impact in the industries we serve.
              </p>

              {/* Mission & Vision */}
              <div className="space-y-6">
                <div className="border-l-4 border-brand-orange pl-6">
                  <h3 className="font-condensed text-xl font-bold bg-brand-orange text-white inline-block px-2 mb-2">OUR MISSION</h3>
                ...
                <div className="border-l-4 border-brand-orange pl-6">
                  <h3 className="font-condensed text-xl font-bold bg-brand-orange text-white inline-block px-2 mb-2">OUR VISION</h3>
                  <p className="text-brand-dark">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {values.map((value, index) => (
                ...
                >
                  ...
                  <h4 className="font-condensed text-xl font-bold bg-brand-orange text-white inline-block px-2 mb-2">
                    {value.title}
                  </h4>
