...
export function Hero() {
  ...
  return (
    <section
      ref={heroRef}
      className="relative min-h-screen w-full overflow-hidden bg-brand-concrete"
    >
      ...
      >
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-l from-transparent via-transparent to-brand-concrete/90" />
        <div className="absolute inset-0 bg-brand-concrete/40" />
      </div>
      ...
      <div
        className={`absolute top-8 left-1/2 -translate-x-1/2 md:left-auto md:right-8 md:translate-x-0 bg-brand-orange text-brand-concrete px-4 py-2 font-condensed font-bold text-sm transition-all duration-800 ${
