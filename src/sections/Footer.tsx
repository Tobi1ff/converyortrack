...
export function Footer() {
  ...
  return (
    <footer className="bg-brand-concrete border-t border-white/10">
      {/* Main Footer */}
            ...
            <div className="lg:col-span-2">
              <div className="flex items-center gap-3 mb-6">
                <div className="w-10 h-10 bg-brand-orange flex items-center justify-center">
                  <MoveRight className="h-6 w-6 text-brand-concrete" />
                </div>
                <div>
              ...
              <div className="flex items-center gap-4">
                <div className="bg-brand-orange text-brand-concrete px-4 py-2 font-condensed font-bold text-sm">
                  LEVEL 1 BBBEE
                </div>
